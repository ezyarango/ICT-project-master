...
#game over screen
def game_over():
    global gameover, player_score, player_x, player_y, obstacles, obstacle_mask, obstacle_rect, running, last_x, obstacle_type, x_pos, y_pos
    while not running:
...
def update_score():
    ...
    text5 = font2.render("Score: " + str(player_score), True, yellow)
    textRect = text5.get_rect()
    textRect.center = (830, 25)
